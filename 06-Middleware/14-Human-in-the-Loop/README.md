# Built-in middleware - Docs by LangChain

Built-in middleware - Docs by LangChain
===============

[Skip to main content](https://docs.langchain.com/oss/python/langchain/middleware/built-in#content-area)
...
On this page
*   [Provider-agnostic middleware](https://docs.langchain.com/oss/python/langchain/middleware/built-in#provider-agnostic-middleware)
*   [Summarization](https://docs.langchain.com/oss/python/langchain/middleware/built-in#summarization)
*   [Human-in-the-loop](https://docs.langchain.com/oss/python/langchain/middleware/built-in#human-in-the-loop)
*   [Model call limit](https://docs.langchain.com/oss/python/langchain/middleware/built-in#model-call-limit)
*   [Tool call limit](https://docs.langchain.com/oss/python/langchain/middleware/built-in#tool-call-limit)
*   [Model fallback](https://docs.langchain.com/oss/python/langchain/middleware/built-in#model-fallback)
*   [PII detection](https://docs.langchain.com/oss/python/langchain/middleware/built-in#pii-detection)
*   [Custom PII types](https://docs.langchain.com/oss/python/langchain/middleware/built-in#custom-pii-types)
*   [To-do list](https://docs.langchain.com/oss/python/langchain/middleware/built-in#to-do-list)
*   [LLM tool selector](https://docs.langchain.com/oss/python/langchain/middleware/built-in#llm-tool-selector)
*   [Tool retry](https://docs.langchain.com/oss/python/langchain/middleware/built-in#tool-retry)
*   [Model retry](https://docs.langchain.com/oss/python/langchain/middleware/built-in#model-retry)
*   [LLM tool emulator](https://docs.langchain.com/oss/python/langchain/middleware/built-in#llm-tool-emulator)
*   [Context editing](https://docs.langchain.com/oss/python/langchain/middleware/built-in#context-editing)
*   [Shell tool](https://docs.langchain.com/oss/python/langchain/middleware/built-in#shell-tool)
*   [File search](https://docs.langchain.com/oss/python/langchain/middleware/built-in#file-search)
*   [Provider-specific middleware](https://docs.langchain.com/oss/python/langchain/middleware/built-in#provider-specific-middleware)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-model)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-trigger)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-keep)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-token-counter)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-summary-prompt)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-trim-tokens-to-summarize)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-summary-prefix)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-max-tokens-before-summary)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-messages-to-keep)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-thread-limit)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-run-limit)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-exit-behavior)
...
### [​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#tool-call-limit)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-tool-name)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-thread-limit-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-run-limit-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-exit-behavior-1)
...
### [​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#model-fallback)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-first-model)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-additional-models)
...
#### [​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#custom-pii-types)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-pii-type)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-strategy)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-detector)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-apply-to-input)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-apply-to-output)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-apply-to-tool-results)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-system-prompt)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-tool-description)
...
### [​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#llm-tool-selector)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-model-1)

model

string | BaseChatModel

Model for tool selection. Can be a model identifier string (e.g., `'openai:gpt-4o-mini'`) or a `BaseChatModel` instance. See [`init_chat_model`](https://reference.langchain.com/python/langchain/models/#langchain.chat_models.init_chat_model(model)) for more information.Defaults to the agent’s main model.

[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-system-prompt-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-max-tools)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-always-include)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-max-retries)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-tools)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-retry-on)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-on-failure)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-backoff-factor)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-initial-delay)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-max-delay)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-jitter)
...
### [​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#model-retry)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-max-retries-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-retry-on-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-on-failure-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-backoff-factor-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-initial-delay-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-max-delay-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-jitter-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-tools-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-model-2)
...
### [​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#context-editing)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-edits)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-token-count-method)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-trigger-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-clear-at-least)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-keep-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-clear-tool-inputs)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-exclude-tools)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-placeholder)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-workspace-root)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-startup-commands)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-shutdown-commands)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-execution-policy)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-redaction-rules)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-tool-description-1)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-shell-command)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-env)
...
### [​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#file-search)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-root-path)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-use-ripgrep)
...
[​](https://docs.langchain.com/oss/python/langchain/middleware/built-in#param-max-file-size-mb)
...
[Anthropic --------- Prompt caching, bash tool, text editor, memory, and file search middleware for Claude models.](https://docs.langchain.com/oss/python/integrations/middleware/anthropic)[OpenAI ------ Content moderation middleware for OpenAI models.](https://docs.langchain.com/oss/python/integrations/middleware/openai)
...
[Overview Previous](https://docs.langchain.com/oss/python/langchain/middleware/overview)[Custom middleware Next](https://docs.langchain.com/oss/python/langchain/middleware/custom)
