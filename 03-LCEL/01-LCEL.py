...
# Create a chain for book recommendations - Old Way
chain = LLMChain(
    prompt=prompt,
    llm=model,
...
#%%
# Example of using RunnableLambda to extract specific information from the output
...
#%%
# Create a chain for answering questions about Python
...
#%%
# Example of using RunnableParallel to combine multiple retrievers
